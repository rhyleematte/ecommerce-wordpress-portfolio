  ...
  return (
    <div className="w-full md:w-64 flex-shrink-0">
      <div className="bg-surface px-8 pb-8 sm:px-6 sm:pb-6 rounded-lg shadow-sm">
        <div className="mb-8">
          <h3 className="font-semibold mb-4 text-text">PRODUCT TYPE</h3>
        ...
        <div className="mb-8">
          <h3 className="font-semibold mb-4 text-text">PRICE</h3>
          <RangeSlider
            id="price-range"
            label="Price"
            min={0}
        ...
        <div className="mb-8">
          <h3 className="font-semibold mb-4 text-text">SIZE</h3>
